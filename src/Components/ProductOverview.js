            ...
            {loading ? <Spinner/> : 
                ...
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <button onClick = {()=> handleSellerInfo()} class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Contact Seller</button>
